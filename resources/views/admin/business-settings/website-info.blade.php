...
<div class="container-fluid pt-8">
    ...
    <div class="shadow overflow-hidden">
        <div class="">
            ...
            <form action="{{ route('business-settings.update-info') }}" method="POST"
            ...
            @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label
                                        class="title-color d-flex">company name</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label class="title-color d-flex">Phone</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <label
                                        class="title-color d-flex">Email</label>
                            ...
                            <div class="col-md-4">
                                @php($company_address=\App\Models\BusinessSetting::where('type','company_address')->first())

                                <div class="form-group">
                                    <label class="title-color d-flex">Company Address</label>
                                    <input type="text" value="{{ $company_address->value?$company_address->value:" " }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="title-color d-flex">Time Zone</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="title-color d-flex">Country </label>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                @php($cancellation_fee=\App\Models\BusinessSetting::where('type','cancellation_fee')->first())
                                <div class="form-group">
                                    <label
                                        class="title-color d-flex">Cacellation Fee</label>
                                    <input class="form-control" type="text" name="cancellation_fee"
                                        value="{{ $cancellation_fee->value?$cancellation_fee->value:" " }}"
                                        placeholder="New Business">
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            {{-- <div class="col-md-4">
                                ...
                                <label class="title-color d-flex">Currency Position</label>
                                <div class="form-row">
                            ...
                            {{-- @php($company_copyright_text=\App\Models\BusinessSetting::where('type','company_copyright_text')->first())
                            @php($fpv=\App\CPU\Helpers::get_business_settings('forgot_password_verification'))
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="title-color d-flex">Forgot Password Verification By </label>
                            ...
                            <div class="col-md-4">
                                @php($company_copyright_text=\App\Models\BusinessSetting::where('type','company_copyright_text')->first())
                                <div class="form-group">
                                    <label class="title-color d-flex">Company Copyright Text</label>
                            ...
                            {{-- <div class="col-md-4">
                                @php($decimal_point=\App\Models\BusinessSetting::where('type','decimal_point_settings')->first())
                                <div class="form-group">
                                    <label
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <input type="color" class="col-4" style="height: 50px" name="primary" value="{{ $data->primary }}"
                                    class="form-control form-control_color">
                                    <div class="text-center col-8">
                                        <div class="title-color">#0071DC</div>
                                        <label class="title-color text-capitalize">Primary Color</label>
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                    <input type="color" class="col-4" style="height: 50px" name="secondary" value="{{ $data->secondary }}"
                                    class="form-control form-control_color">
                                    <div class="text-center col-8">
                                        <div class="title-color">#334257</div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                <center>
                                    <img class="img-fluid" width="70" height="70"
                                            src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]}}">
                                </center>
                                <div class="position-relative">
                                    ...
                                    <label class="custom-file-label"
                                            for="customFileUploadWL">choose file</label>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                <center>
                                    <img class="img-fluid" width="70" height="70"
                                            src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'driver_icon'])->pluck('value')[0]}}">
                                </center>
                                <div class="position-relative">
                                    <input type="file" name="driver_icon" id="customFileUploadWL"
                                            class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                            for="customFileUploadWL">choose file</label>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                <center>
                                    <img class="img-fluid" width="70" height="70"
                                    src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0]}}">
                                </center>
                                <div class="position-relative mt-4">
                                    <input type="file" name="company_footer_logo" id="customFileUploadWFL"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                            for="customFileUploadWFL">Choose file</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            <div class="card-header">
                                ...
                                <span class="badge badge-soft-info">ratio 1:1</span>
                            </div>
                            <div class="card-body d-flex flex-column justify-content-around">
                                <center>
                                    <img class="img-fluid" width="70" height="70"
                                    src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0]}}">
                                </center>
                                <div class="position-relative mt-4">
                                    <input type="file" name="company_fav_icon" id="customFileUploadFI"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                            for="customFileUploadFI">Choose file</label>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                ...
                                <div class="position-relative mt-4">
                                    <input type="file" name="loader_gif" id="customFileUploadLoader"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                            for="customFileUploadLoader">Choose File</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="card h-100">
                            ...
                            <div class="card-body d-flex flex-column justify-content-around">
                                <center>
                                    <img class="img-fluid" width="70" height="70"
                                    src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0]}}">
                                </center>
                                <div class="mt-4 position-relative">
                                    <input type="file" name="company_mobile_logo" id="customFileUploadML"
                                            ...
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                    <label class="custom-file-label"
                                            for="customFileUploadML">Choose file</label>
                                </div>
                            </div>
                        </div>
                    </div>
