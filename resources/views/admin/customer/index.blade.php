                    ...
                    <tbody>
                        @foreach ($data as $d)
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <select name="" onchange="changeStaus(this.value, {{ $d->id }})" id="">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title" id="exampleModalLabel">Customer Delete</h2>
...
function getEditId(id) {
    $.ajax({
        type: 'GET',
        url: '{{ url('admin/customer/get/delete') }}/' + id,
        contentType: "application/json",
        dataType: "json",
        success: function(data) {
