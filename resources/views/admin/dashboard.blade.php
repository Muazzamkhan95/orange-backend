            ...
            <div class="row">
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 stats">
                    <div class="text-center">
                        ...
                        <a href="{{ route('admin.booking.index')}}" class="btn btn-outline-primary btn-pill btn-sm">View All</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 stats">
                    <div class="text-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 stats">
                    <div class="text-center">
                        ...
                        <a href="{{ route('admin.customer.index')}}" class="btn btn-outline-warning btn-pill btn-sm">View All</a>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 stats">
                    <div class="text-center">
                        ...
                        <a href="{{ route('admin.driver.index')}}" class="btn btn-outline-danger btn-pill btn-sm">View All</a>
                    </div>
                </div>
