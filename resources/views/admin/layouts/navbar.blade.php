    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav align-items-center ">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="media align-items-center">
                    <span class="avatar avatar-sm rounded-circle"><img alt="Image placeholder" src="{{ asset('/')}}{{\App\Models\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]}}"></span>
                    <div class="media-body ml-2 d-none d-lg-block">
                        <span class="mb-0 ">{{\App\Models\BusinessSetting::where(['type' => 'company_name'])->pluck('value')[0]}}</span>
                    </div>
                </div></a>
